...
public class Constants {
    ...
    public static final String METRIC_FILE_DIRECTORY = "/var/log/";
    public static final String METRIC_FILE = "brute_metrics.json";
    public static final String METRIC_FILE_LOCATION = METRIC_FILE_DIRECTORY + METRIC_FILE;

    // Tracker File
    public static final String TRACKER_FILE_DIRECTORY = "/var/log/"; // MAKE SURE THE DIRECTORY FOR BE_LOG_FILE ARE THE SAME. windows variant
    ...
    // Log File
    public static final String LOG_FILE_DIRECTORY = "/var/log/";
